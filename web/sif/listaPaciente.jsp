    ...
    <div id="wrapper">    
		...
		<div id="page-wrapper">
			<ol class="breadcrumb">
			  ...
			  <li class="active"><i class="glyphicon glyphicon-list-alt"></i> Pacientes Cadastrados</a></li>
			</ol>
			
			<div class="alert alert-info" role="alert">
			  <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
				Digite o <b><u>Nº do Cart&atilde;o SUS</u></b> e clique em <b>PESQUISAR!</b>
			</div>
			
			<!-- Page Heading -->
            <div class="row">
                <div class="col-lg-12">
                   <h1 class="page-header">Pacientes Cadastrados</h1>
					<div class="form-group col-md-3"></div>
						<div class="row "  align="center">
							<div class="col-lg-6">
								<div class="input-group">
								<input type="text" class="form-control" placeholder="DIGITE O N&ordm; CART&Atilde;O SUS">
			...
			<div>
				...
				<ul class="nav nav-tabs nav-justified " role="tablist" id="myTabs">
					<li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab"><b>DADOS DO PACIENTE</b></a></li>
					<li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab"><b>FICHA DE AVALI&Ccedil;&Atilde;O</b></a></li>
					<!--li role="presentation"><a href="#messages" aria-controls="messages" role="tab" data-toggle="tab"><b>DISPONIBILIDADE PARA SESS&Otilde;ES</b></a></li-->
				</ul>
				...
				<div class="tab-content">
					...
					<div role="tabpanel" class="tab-pane active" id="home"></br>
						...
						<div>
							<button type="button" class="btn btn-primary">AVAN&Ccedil;AR 1 <i class="glyphicon glyphicon-arrow-right"></i></button>
						</div>
					</div>
					...
					<div role="tabpanel" class="tab-pane" id="profile"></br>
					  <div>
						...
						<div>
							<button type="button" class="btn btn-danger"><a href="agenda.jsp">VOLTAR</a></button>
							<button type="button" class="btn btn-success">ATUALIZAR <i class="glyphicon glyphicon-repeat"></i></button>
						</div>
					...
					<!--div role="tabpanel" class="tab-pane" id="messages"></br>
						<div align="center">
							...
							<!--div>
								<button type="button" class="btn btn-success">CADASTRAR E GERAR FICHA DE PRESEN&Ccedil;A<i class="glyphicon glyphicon-floppy-disk"></i></button>
							</div>
						</div>
					</div-->
